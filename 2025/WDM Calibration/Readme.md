...
* Title: _"A Comparison of Galacticus and COZMIC WDM Subhalo Populations"_
...
The .xml files present in this folder are the CDM/WDM Galacticus parameter files used to produce Galacticus data for the paper.
